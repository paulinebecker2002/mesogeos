#!/bin/bash
#SBATCH --job-name=transformer-gridsearch
...
CONFIG_TRAIN_PATH="/hkfs/work/workspace/scratch/uyxib-mesogeos2/code/ml_tracks/a.fire_danger/configs/config_transformer/config_train.json"
TRAIN_SCRIPT="/hkfs/work/workspace/scratch/uyxib-mesogeos2/code/ml_tracks/a.fire_danger/train.py"

SAVE_DIR="/hkfs/work/workspace/scratch/uyxib-mesogeos2/code/ml_tracks/a.fire_danger/saved/models"
CONFIG_TEST_PATH="/hkfs/work/workspace/scratch/uyxib-mesogeos2/code/ml_tracks/a.fire_danger/configs/config_transformer/config_test.json"
TEST_SCRIPT="/hkfs/work/workspace/scratch/uyxib-mesogeos2/code/ml_tracks/a.fire_danger/test.py"
