#!/bin/bash
#SBATCH --job-name=mlp_gridsearch
...
CONFIG_TRAIN_PATH="/hkfs/work/workspace/scratch/uyxib-mesogeos2/code/ml_tracks/a.fire_danger/configs/config_mlp/config_train.json"
...
CONFIG_TEST_PATH="/hkfs/work/workspace/scratch/uyxib-pauline_gddpfa/mesogeos/code/ml_tracks/a.fire_danger/configs/config_mlp/config_test.json"
...
for lr in 0.001 0.00125 0.00075
do
  for dr in 0.075 0.1 0.125
  do
    for bs in 256
    do
