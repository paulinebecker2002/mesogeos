...
CONFIG_TRAIN_PATH="/hkfs/work/workspace/scratch/uyxib-mesogeos2/code/ml_tracks/a.fire_danger/configs/config_gtn/config_train.json"
...
CONFIG_TEST_PATH="/hkfs/work/workspace/scratch/uyxib-mesogeos2/code/ml_tracks/a.fire_danger/configs/config_gtn/config_test.json"
